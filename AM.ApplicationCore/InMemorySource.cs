...
namespace AM.ApplicationCore
{
    public static class InMemorySource
    {
        ...
        public static readonly Flight Flight4 = new Flight { FlightDate = new DateTime(2022, 1, 1, 6, 10, 0), Departure = "Tunis", Destination = "Madrid", EffectiveArrival = new DateTime(2022, 1, 1, 8, 40, 0), EstimatedDuration = 2.5f, Plane = Boeing2 };
        public static readonly Flight Flight5 = new Flight { FlightDate = new DateTime(2022, 1, 1, 17, 10, 0), Departure = "Tunis", Destination = "Madrid", EffectiveArrival = new DateTime(2022, 1, 1, 19, 40, 0), EstimatedDuration = 2.5f, Plane = Airbus };
        public static readonly Flight Flight6 = new Flight { FlightDate = new DateTime(2022, 1, 1, 20, 10, 0), Departure = "Tunis", Destination = "Lisbonne", EffectiveArrival = new DateTime(2022, 1, 1, 23, 10, 0), EstimatedDuration = 3, Plane = Airbus };
